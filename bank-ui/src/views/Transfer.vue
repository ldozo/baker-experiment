<template>
  <div class="">
    <div class="grid gap-2 mt-6">
                  ...
                  >
                    ...
                    >
                      <span class="text-sm text-gray-800 grid">
                        ...
                        <span v-if="sourceAccount?.id === a.id"
                            class="flex items-center rounded bg-indigo-100 text-xs font-medium text-indigo-700"
                          >
                            Selected
                        </span>
                      </span>
                ...
                <div>
                  ...
                  >
                    ...
                    <span class="text-sm text-gray-800 grid">
                        ...
                        <span>{{ accountLabel(a) }}</span>
                        <span>{{ a.balance + ' ' + a.currency }}</span>
                        <span v-if="targetAccount?.id === a.id"
                            class="flex items-center rounded bg-indigo-100 text-xs font-medium text-indigo-700"
                          >
                            Selected
                        </span>
      ...
      <div class="bg-white border rounded-lg p-6 grid gap-2">
        <div class="">
          <h2>Request</h2>
          <JsonViewer :value="lastRequest" :collapsed="false" :collapseDepth="2" :sortKeys="true" :showTypes="true" rootLabel="root" />
        </div>
        <div class="">
          <h2>Response</h2>
          <JsonViewer :value="lastResponse" :collapsed="false" :collapseDepth="2" :sortKeys="true" :showTypes="true" rootLabel="root"  maxHeight="max-h-96"/>
        </div>
      </div>
    </div>
